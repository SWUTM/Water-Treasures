...
public class WaterWoodBowl2RightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
				.getItem() == WaterTreasuresModItems.WATER_WOOD_BOWL_2.get()) {
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(WaterTreasuresModItems.WATER_WOOD_BOWL_2.get());
